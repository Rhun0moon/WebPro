...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="tbl01" cellpadding="0" cellspacing="0" width="1920px">
        <tr>
            <td width="5px"></td><td class="td01"></td>
        </tr>
        <tr>
            <td width="100px"></td>
            <td class="td03" width="500px">
                <img src="../images/title_icon.gif" />&nbsp;&nbsp;&nbsp;비밀번호 확인
            </td>
        </tr>
        <tr>
            <td></td>
        ...
        <tr>
            <td></td>
            <td class="td04"> ※ 글을 작성했을 때 입력한 비밀번호를 입력하세요.</td>
        </tr>
        <tr>
            <td></td>
            <td height="15"></td>
            ...
            <tr>
                ...
                <td>
                    <table class="tbl01" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td style="padding-left:20px; height:30px; width:100px">· 글 비밀번호</td>
                            <td>
    ...
    <table class="tbl01" cellpadding="0" cellspacing="0">
        <tr>
            <td width="5px" height="15px"></td><td colspan="3"></td>
        </tr>
        <tr>
            <td width="600"></td><td class="td06"></td><td align="left">
        ...
        <tr>
            <td height="10px"></td><td colspan="3"></td>
        </tr>
    </table>
</asp:Content>
